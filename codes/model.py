### generated by caffe2fluid, your net is in class "FacialNet" ###
...
class FacialNet(Network):
    ### automatically generated by caffe2fluid ###
    inputs_info = {"data": [1, 42, 42]}
    custom_layers_path = "/home/hxyu/models/PaddleCV/caffe2fluid/kaffe"
    ...
    def custom_layer_factory(self):
        ...
        location = FacialNet.custom_layers_path
        pk_dir = os.path.join(FacialNet.custom_layers_path, pk_name)
        pk_paths.append((location, pk_dir))
    ...
    def setup(self):
        self.feed('data')
        self.conv(5, 5, 32, 1, 1, padding=[2, 2], name='conv1')
        self.lrn(5, 1.99999994948e-05, 0.75, name='norm1')
        self.max_pool(3, 3, 2, 2, True, name='pool1')
        self.conv(4, 4, 32, 2, 2, padding=[1, 1], name='conv2')
        self.lrn(5, 1.99999994948e-05, 0.75, name='norm2')
        self.max_pool(3, 3, 2, 2, True, name='pool2')
        self.conv(5, 5, 64, 1, 1, padding=[2, 2], name='conv3')
        self.lrn(5, 1.99999994948e-05, 0.75, name='norm3')
        self.max_pool(3, 3, 2, 2, True, name='pool3')
        self.fc(2048, name='fc4')
        self.fc(1024, name='fc5')
        self.fc(7, relu=False, name='fc6')
        self.softmax(1, name='prob')
...
def main():
    ...
    ret = FacialNet.convert(npy_weight, fluid_model, outputs)
    if ret == 0:
